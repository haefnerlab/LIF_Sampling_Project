...
#                if m<2:    
                np.save(path + 'SpikesforStatistics_NaturalImagesSingleNeuron' + '_' + str(neurons) + '_' + model + '.npy',spikes_im)
                np.save(path + 'SamplesforStatistics_NaturalImagesSingleNeuron' + '_' + str(neurons) + '_' + model + '.npy',samples_im)
